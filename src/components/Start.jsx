  ...
  return (
   ...
   <div className='w-90 px-10 py-15 shadow-2xl flex flex-col space-y-2 justify-center items-center'>
         ...
         <div className='w-90 px-10 py-15 shadow-2xl flex flex-col space-y-2 justify-center items-center'>
             ...
             <img className=' bg-[#f4e8ff] rounded-md flex items-center justify-center p-4' src="/src/assets/package.png" alt="" />
         ...
         <div className='w-90 px-10 py-15 shadow-2xl flex flex-col space-y-2 justify-center items-center'>
             ...
             <img className=' bg-[#f4e8ff] rounded-md flex items-center justify-center p-4' src="/src/assets/rocket.png" alt="" />
